...
public class DBHandler extends SQLiteOpenHelper
{
    ...
    public void insertDiet(String food, float calories, String date)
    {
    ...
    public void insertExercise(String activity, float timeSpent, String date)
    {
        ContentValues values = new ContentValues();
    ...
    public void insertSleep(float timeSpent, String date)
    {
        ContentValues values = new ContentValues();
    ...
    public ArrayList<Diet> getDietInfo()
    {
        ...
        if (cursor.moveToFirst()) {
            do {
                Diet diet = new Diet(cursor.getString(0), cursor.getFloat(1), cursor.getString(2));
                list.add(diet);
    ...
    public ArrayList<Exercise> getExerciseInfo()
    {
        ...
        if (cursor.moveToFirst()) {
            do {
                Exercise exercise = new Exercise(cursor.getString(0), cursor.getFloat(1), cursor.getString(2));
                list.add(exercise);
            } while (cursor.moveToNext());
        }
    ...
    public ArrayList<Sleep> getSleepInfo()
    {
        ...
        if (cursor.moveToFirst()) {
            do {
                Sleep sleep = new Sleep(cursor.getFloat(0), cursor.getString(1));
                list.add(sleep);
            } while (cursor.moveToNext());
        }
